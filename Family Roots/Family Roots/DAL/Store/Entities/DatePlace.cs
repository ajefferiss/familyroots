namespace Family_Roots.DAL.Store.Entities
{
    ...
    public class DatePlace
    {
        ...
        /// </summary>
        [Column("description", false, DataTypes.Nvarchar, 2048, false)]
